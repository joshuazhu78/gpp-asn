...
var SubTypetype2R16knownImplementations = []isSubTypetype2R16_SubTypetype2R16{
	&SubTypetype2R16_TypeIiR16{},
	&SubTypetype2R16_TypeIiPortSelectionR16{},
}

func (c *SubTypetype2R16) UnmarshalJSON(bytes []byte) error {
	var data struct {
		Type  string
	...
	for _, knownImplementation := range SubTypetype2R16knownImplementations {
		...
		if knownType.String() == data.Type {
			...
			c.SubTypetype2R16 = target.Elem().Interface().(isSubTypetype2R16_SubTypetype2R16)
			return nil
		}
	}
	return nil
...
func (c SubTypetype2R16) MarshalJSON() ([]byte, error) {
	// Marshal to type and actual data to handle unmarshaling to specific interface type
	return json.Marshal(struct {
		Type  string
		Value any
	}{
		Type:  reflect.TypeOf(c.SubTypetype2R16).String(),
		Value: c.SubTypetype2R16,
	})
}

var _ json.Unmarshaler = (*SubTypetype2R16)(nil)
