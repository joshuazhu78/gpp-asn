...
var ReportConfigTypeCsiReportConfigknownImplementations = []isReportConfigTypeCsiReportConfig_ReportConfigTypeCsiReportConfig{
...
func (c *ReportConfigTypeCsiReportConfig) UnmarshalJSON(bytes []byte) error {
	var data struct {
		Type  string
	...
	for _, knownImplementation := range ReportConfigTypeCsiReportConfigknownImplementations {
		...
		if knownType.String() == data.Type {
			...
			c.ReportConfigTypeCsiReportConfig = target.Elem().Interface().(isReportConfigTypeCsiReportConfig_ReportConfigTypeCsiReportConfig)
			return nil
		}
	}
	return nil
...
func (c ReportConfigTypeCsiReportConfig) MarshalJSON() ([]byte, error) {
	// Marshal to type and actual data to handle unmarshaling to specific interface type
	return json.Marshal(struct {
		Type  string
		Value any
	}{
		Type:  reflect.TypeOf(c.ReportConfigTypeCsiReportConfig).String(),
		Value: c.ReportConfigTypeCsiReportConfig,
	})
}

var _ json.Unmarshaler = (*ReportConfigTypeCsiReportConfig)(nil)
