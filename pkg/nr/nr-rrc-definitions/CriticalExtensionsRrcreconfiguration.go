...
var CriticalExtensionsRrcreconfigurationknownImplementations = []isCriticalExtensionsRrcreconfiguration_CriticalExtensionsRrcreconfiguration{
	&CriticalExtensionsRrcreconfiguration_RrcReconfiguration{},
	&CriticalExtensionsRrcreconfiguration_CriticalExtensionsFuture{},
}

func (c *CriticalExtensionsRrcreconfiguration) UnmarshalJSON(bytes []byte) error {
	var data struct {
		Type  string
	...
	for _, knownImplementation := range CriticalExtensionsRrcreconfigurationknownImplementations {
		...
		if knownType.String() == data.Type {
			...
			c.CriticalExtensionsRrcreconfiguration = target.Elem().Interface().(isCriticalExtensionsRrcreconfiguration_CriticalExtensionsRrcreconfiguration)
			return nil
		}
	}
	return nil
...
func (c CriticalExtensionsRrcreconfiguration) MarshalJSON() ([]byte, error) {
	// Marshal to type and actual data to handle unmarshaling to specific interface type
	return json.Marshal(struct {
		Type  string
		Value any
	}{
		Type:  reflect.TypeOf(c.CriticalExtensionsRrcreconfiguration).String(),
		Value: c.CriticalExtensionsRrcreconfiguration,
	})
}

var _ json.Unmarshaler = (*CriticalExtensionsRrcreconfiguration)(nil)
