...
var UlCcch1MessageTypeknownImplementations = []isUlCCch1MessageType_UlCcch1MessageType{
	&UlCCch1MessageType_C1{},
	&UlCCch1MessageType_MessageClassExtension{},
}

func (c *UlCCch1MessageType) UnmarshalJSON(bytes []byte) error {
	var data struct {
		Type  string
	...
	for _, knownImplementation := range UlCcch1MessageTypeknownImplementations {
		...
		if knownType.String() == data.Type {
			...
			c.UlCcch1MessageType = target.Elem().Interface().(isUlCCch1MessageType_UlCcch1MessageType)
			return nil
		}
	}
	return nil
...
func (c UlCCch1MessageType) MarshalJSON() ([]byte, error) {
	// Marshal to type and actual data to handle unmarshaling to specific interface type
	return json.Marshal(struct {
		Type  string
		Value any
	}{
		Type:  reflect.TypeOf(c.UlCcch1MessageType).String(),
		Value: c.UlCcch1MessageType,
	})
}

var _ json.Unmarshaler = (*UlCCch1MessageType)(nil)
