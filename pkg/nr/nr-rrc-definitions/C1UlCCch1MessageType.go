...
var C1UlCcch1MessageTypeknownImplementations = []isC1UlCCch1MessageType_C1UlCcch1MessageType{
...
func (c *C1UlCCch1MessageType) UnmarshalJSON(bytes []byte) error {
	var data struct {
		Type  string
	...
	for _, knownImplementation := range C1UlCcch1MessageTypeknownImplementations {
		...
		if knownType.String() == data.Type {
			...
			c.C1UlCcch1MessageType = target.Elem().Interface().(isC1UlCCch1MessageType_C1UlCcch1MessageType)
			return nil
		}
	}
	return nil
...
func (c C1UlCCch1MessageType) MarshalJSON() ([]byte, error) {
	// Marshal to type and actual data to handle unmarshaling to specific interface type
	return json.Marshal(struct {
		Type  string
		Value any
	}{
		Type:  reflect.TypeOf(c.C1UlCcch1MessageType).String(),
		Value: c.C1UlCcch1MessageType,
	})
}

var _ json.Unmarshaler = (*C1UlCCch1MessageType)(nil)
