...
var CriticalExtensionsMeasurementReportknownImplementations = []isCriticalExtensionsMeasurementReport_CriticalExtensionsMeasurementReport{
	&CriticalExtensionsMeasurementReport_MeasurementReport{},
	&CriticalExtensionsMeasurementReport_CriticalExtensionsFuture{},
}

func (c *CriticalExtensionsMeasurementReport) UnmarshalJSON(bytes []byte) error {
	var data struct {
		Type  string
	...
	for _, knownImplementation := range CriticalExtensionsMeasurementReportknownImplementations {
		...
		if knownType.String() == data.Type {
			...
			c.CriticalExtensionsMeasurementReport = target.Elem().Interface().(isCriticalExtensionsMeasurementReport_CriticalExtensionsMeasurementReport)
			return nil
		}
	}
	return nil
...
func (c CriticalExtensionsMeasurementReport) MarshalJSON() ([]byte, error) {
	// Marshal to type and actual data to handle unmarshaling to specific interface type
	return json.Marshal(struct {
		Type  string
		Value any
	}{
		Type:  reflect.TypeOf(c.CriticalExtensionsMeasurementReport).String(),
		Value: c.CriticalExtensionsMeasurementReport,
	})
}

var _ json.Unmarshaler = (*CriticalExtensionsMeasurementReport)(nil)
