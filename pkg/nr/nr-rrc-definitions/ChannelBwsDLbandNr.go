...
var ChannelBwsDlbandNrknownImplementations = []isChannelBwsDLbandNr_ChannelBwsDlbandNr{
	&ChannelBwsDLbandNr_Fr1{},
	&ChannelBwsDLbandNr_Fr2{},
}

func (c *ChannelBwsDLbandNr) UnmarshalJSON(bytes []byte) error {
	var data struct {
		Type  string
	...
	for _, knownImplementation := range ChannelBwsDlbandNrknownImplementations {
		...
		if knownType.String() == data.Type {
			...
			c.ChannelBwsDlbandNr = target.Elem().Interface().(isChannelBwsDLbandNr_ChannelBwsDlbandNr)
			return nil
		}
	}
	return nil
...
func (c ChannelBwsDLbandNr) MarshalJSON() ([]byte, error) {
	// Marshal to type and actual data to handle unmarshaling to specific interface type
	return json.Marshal(struct {
		Type  string
		Value any
	}{
		Type:  reflect.TypeOf(c.ChannelBwsDlbandNr).String(),
		Value: c.ChannelBwsDlbandNr,
	})
}

var _ json.Unmarshaler = (*ChannelBwsDLbandNr)(nil)
