...
var CceRegMappingTypeControlResourceSetknownImplementations = []isCceREgMappingTypeControlResourceSet_CceRegMappingTypeControlResourceSet{
	&CceREgMappingTypeControlResourceSet_Interleaved{},
	&CceREgMappingTypeControlResourceSet_NonInterleaved{},
}

func (c *CceREgMappingTypeControlResourceSet) UnmarshalJSON(bytes []byte) error {
	var data struct {
		Type  string
	...
	for _, knownImplementation := range CceRegMappingTypeControlResourceSetknownImplementations {
		...
		if knownType.String() == data.Type {
			...
			c.CceRegMappingTypeControlResourceSet = target.Elem().Interface().(isCceREgMappingTypeControlResourceSet_CceRegMappingTypeControlResourceSet)
			return nil
		}
	}
	return nil
...
func (c CceREgMappingTypeControlResourceSet) MarshalJSON() ([]byte, error) {
	// Marshal to type and actual data to handle unmarshaling to specific interface type
	return json.Marshal(struct {
		Type  string
		Value any
	}{
		Type:  reflect.TypeOf(c.CceRegMappingTypeControlResourceSet).String(),
		Value: c.CceRegMappingTypeControlResourceSet,
	})
}

var _ json.Unmarshaler = (*CceREgMappingTypeControlResourceSet)(nil)
