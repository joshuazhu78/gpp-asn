...
var PdcchConfigCommonBwpDownlinkCommonknownImplementations = []isPdcchConfigCommonBwpDownlinkCommon_PdcchConfigCommonBwpDownlinkCommon{
	&PdcchConfigCommonBwpDownlinkCommon_Release{},
	&PdcchConfigCommonBwpDownlinkCommon_Setup{},
}

func (c *PdcchConfigCommonBwpDownlinkCommon) UnmarshalJSON(bytes []byte) error {
	var data struct {
		Type  string
	...
	for _, knownImplementation := range PdcchConfigCommonBwpDownlinkCommonknownImplementations {
		...
		if knownType.String() == data.Type {
			...
			c.PdcchConfigCommonBwpDownlinkCommon = target.Elem().Interface().(isPdcchConfigCommonBwpDownlinkCommon_PdcchConfigCommonBwpDownlinkCommon)
			return nil
		}
	}
	return nil
...
func (c PdcchConfigCommonBwpDownlinkCommon) MarshalJSON() ([]byte, error) {
	// Marshal to type and actual data to handle unmarshaling to specific interface type
	return json.Marshal(struct {
		Type  string
		Value any
	}{
		Type:  reflect.TypeOf(c.PdcchConfigCommonBwpDownlinkCommon).String(),
		Value: c.PdcchConfigCommonBwpDownlinkCommon,
	})
}

var _ json.Unmarshaler = (*PdcchConfigCommonBwpDownlinkCommon)(nil)
